{{--
    Styling for rich-text bodies shown as a full page of their own, as opposed
    to the condensed .prose-section preview used in a course's material list.

    Extracted so the "open as separate page" view and the assignment
    description render identically — they were the same content styled two
    different ways, which is exactly the kind of thing that silently drifts.

    @once so including it from several places on one page emits it only once.
--}}
@once
@push('head')
    <style>
